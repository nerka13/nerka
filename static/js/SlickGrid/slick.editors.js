 ...
 function SelectCellEditor(args) {
    ...
    this.init = function() {
        ...
        for(var i=0;i<length;i++){
          option_str += "<OPTION value='"+tuples[i][0]+"'>"+tuples[i][1]+"</OPTION>";
        }
        //ini
        //$select = $("<SELECT tabIndex='0' class='editor-select' style='position:absolute; top:-1px; left:-1px;width:35px; height:25px; background:#fbfbf0; border-color:rgb(192, 192, 192);'>"+ option_str +"</SELECT>");
